      ...
      {!isPast(startDate) && (
        <div className="flex flex-col border-l border-primary-800 w-[100px]">
          <Link
            ...
            className="group flex items-center gap-2 uppercase text-xs font-bold text-primary-300 border-b border-primary-800 flex-grow px-3 hover:bg-green-600 transition-colors hover:text-primary-900"
          >
